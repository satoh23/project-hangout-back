...
from .activity_time_frame import ActivityTimeFrame
...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    user_twitter_url = models.URLField('Twitter', blank=True, null=True)
    own_point = models.PositiveIntegerField('所持ポイント', blank=True, default=0)
    gender_id = models.ForeignKey(Gender, verbose_name='性別', blank=True, null=True, on_delete=models.PROTECT)
    state_id = models.ForeignKey(State, verbose_name='現在の状態', blank=True, null=True, on_delete=models.PROTECT)
    activity_time_frame_id = models.ForeignKey(
        ActivityTimeFrame, verbose_name='主なログイン時間', blank=True, null=True, on_delete=models.PROTECT)
    race_id = models.ForeignKey(Race, verbose_name='タイプ', blank=True, null=True, on_delete=models.PROTECT)
